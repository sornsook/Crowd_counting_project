...
#    cols = None
    ...
    conv3_1 = Conv2D(256//2,(3, 3), activation='relu', padding='same')(pool2)
    conv3_2 = Conv2D(256//2,(3, 3), activation='relu', padding='same')(conv3_1)
    conv3_3 = Conv2D(256//2,(3, 3), activation='relu', padding='same')(conv3_2)
    pool3   = MaxPooling2D(pool_size=(2,2))(conv3_3)
    
    conv4_1 = Conv2D(512//2,(3, 3), activation='relu', padding='same')(pool3)
    conv4_2 = Conv2D(512//2,(3, 3), activation='relu', padding='same')(conv4_1)
    conv4_3 = Conv2D(512//2,(3, 3), activation='relu', padding='same')(conv4_2)
    ...
    conv5_1 = Conv2D(512//2,(3, 3), activation='relu',dilation_rate = 2, padding='same')(up4)
    conv5_2 = Conv2D(512//2,(3, 3), activation='relu',dilation_rate = 2,padding='same')(conv5_1)
    conv5_3 = Conv2D(512//2,(3, 3), activation='relu',dilation_rate = 2,padding='same')(conv5_2)
    conv5_4 = Conv2D(256//2,(3, 3), activation='relu',dilation_rate = 2,padding='same')(conv5_3)
    conv5_5 = Conv2D(128//2,(3, 3), activation='relu',dilation_rate = 2, padding='same')(conv5_4)
    conv5_6 = Conv2D(64//2 ,(3, 3), activation='relu',dilation_rate = 2, padding='same')(conv5_5)
